(() => {
  ...
  const translations = {
    ko: {
      ...
      processBody: "야채의 색과 식감이 자연스럽게 남도록 준비해, 밥 위에 간편하게 뿌릴 수 있습니다.",
      processOne: "증숙",
      processTwo: "저온 열풍 건조",
      processThree: "고온 열처리",
      processFour: "토퍼 형태로 마무리",
      ...
      foodCareBody: "야채를 씻고 손질하고 익힌 뒤, 오래 두고 먹이기 좋게 건조해 담았습니다. 먹이고 싶은 날 용기를 열어 필요한 만큼 밥 위에 뿌려주세요.",
      foodCareBridge: "번거로운 야채 준비는 저희가 할게요.",

      foodIngredientsTitle: "국내산 고구마, 당근, 단호박으로<br>만듭니다.",
      foodIngredientsBody: "세 가지 야채를 각각 준비해 고유한 색과 향, 식감이 자연스럽게 남도록 만듭니다. 밥 위에 야채와 식이섬유를 간편하게 더해줄 수 있습니다.",
      foodIngredientFact1: "국내산 야채",
      foodIngredientFact1Body: "고구마·당근·단호박 모두 국내산 원료를 사용합니다.",
      foodIngredientFact2: "식이섬유",
      foodIngredientFact2Body: "야채의 식이섬유도 함께 담았습니다.",
      ...
      foodTextureBody: "야채의 모양이 조금씩 남아 있어 밥 위에 뿌렸을 때 어떤 야채인지 눈으로도 알 수 있습니다. 두 가지 이상을 함께 섞으면 야채마다 다른 색과 식감도 자연스럽게 어우러집니다.",
      ...
      storyOriginBody1: "반려동물이 밥을 맛있게 먹는 모습은 보호자에게도 큰 즐거움입니다. 그래서 한 끼를 챙길 때 맛뿐 아니라 어떤 재료로 만들었는지도 자연스럽게 보게 됩니다.",
      ...
      storyJourney3Body: "국내산 고구마·당근·단호박을 밥 위에 간편하게 더할 수 있도록 만들었습니다.",
    ...
    en: {
      ...
      foodCareBody: "We wash, prepare, cook and dry the vegetables so they are ready when you need them. Open the jar and sprinkle the amount you want over the meal.",
      ...
      foodIngredientsBody: "Each vegetable is prepared separately so its own color, aroma and texture can remain. It is an easy way to add vegetables and fiber to the bowl.",
      ...
      foodTextureBody: "Small pieces of the vegetable remain visible, so you can still see what is going into the bowl. Mix two or more varieties and their colors and textures come together naturally.",
      ...
      storyOriginBody1: "Seeing a pet enjoy a meal makes the person serving it happy too. It also makes us pay closer attention to the ingredients that go into every bowl.",
      ...
      storyJourney3Body: "Korean-grown sweet potato, carrot and kabocha are prepared so they can be added easily to the bowl.",
  ...
  const seo = {
    home: {
      ko: {
        ...
        description: "PETSRO는 반려동물의 먹는 즐거움을 고민하는 브랜드입니다. 대표 제품 Veggie Topper는 국내산 야채로 만들어 밥 위에 간편하게 뿌려주는 반려견용 토퍼입니다.",
        ogTitle: "PETSRO 페츠로 | Vegetable Meal Topper",
        ogDescription: "국내산 야채로 만들어 밥 위에 간편하게 뿌려주는 PETSRO Veggie Topper."
      },
      en: {
